...
"""
Modifed from timm_new. https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
from timm_new.layers import DropPath, to_2tuple, trunc_normal_, _assert
